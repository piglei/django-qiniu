...
import qiniu.rs
import qiniu.io
from django_qiniu.utils import get_size
...
try:
    ...
    add_introspection_rules([], ["^django_qiniu\.fields\.QiNiuFileField"])
    add_introspection_rules([], ["^django_qiniu\.fields\.QiNiuImageField"])
except ImportError:
    pass
